...
public class Restaurant extends Entity {
	 ...
	 */
	public MonetaryAmount calculateBenefitFor(Account account, MonetaryAmount diningAmount) {
		if (benefitAvailabilityPolicy.isBenefitAvailableFor(account, diningAmount)) {
			return diningAmount.multiplyBy(benefitPercentage);
		} else {
