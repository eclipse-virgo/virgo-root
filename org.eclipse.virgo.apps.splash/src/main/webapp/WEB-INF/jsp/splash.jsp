...
<body class="main tundra">
    ...
    <div id="container">
      <div id="content-no-nav">
        ...
        <ul>
          <li><a href="http://www.eclipse.org/virgo" target="_blank" title="Virgo Web Server&#153; - Project Home">Virgo Web Server&#153; - Project Home</a>, includes links to the User, Programmer and Getting Started Guides</li>
