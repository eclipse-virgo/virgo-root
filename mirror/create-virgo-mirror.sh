...
./mvnw install:install-file \
  -Dfile=org.eclipse.gemini.management-1.0.5.RELEASE.jar \
  -DgroupId=org.eclipse.gemini.management \
  -DartifactId=org.eclipse.gemini.management \
  -Dversion=1.0.5.RELEASE \
  -Dpackaging=jar \
  -DlocalRepositoryPath=mavenRepository
